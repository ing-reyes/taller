...
export class PaymentMethodsService {
  ...
  ): Promise<ApiOneResponse<PaymentMethodEntity>> {
    try {
      const method = await this.paymentMethodsRepository.save(
  ...
  ): Promise<ApiAllResponse<PaymentMethodEntity>> {
  ...
  async update(
    ...
    try {
      const method = await this.paymentMethodsRepository.update(
        { id, isActive: true },
